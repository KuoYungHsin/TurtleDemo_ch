...
('mainloop'  ,   '主迴圈', '進入主迴圈', '做完了', '點擊X結束', '等待閉幕', '閉幕',  'zhuhuiquan', 'メインループ'),
...
('reset',                       '重設','chongshe'),
('forward',                     '前進','qianjin', '進める'),
('back',                        '後退','houtui', '後退'),
('right',                       '右轉','youzhuan', '右折'),
('left',                        '左轉','zuozhuan', '左'),
('pos',                         '位置','weizhi'),
...
('shape',                           '形狀'),
('write',                           '寫'),
('begin_fill',                      '開始填', '開始填色', '塗りつぶ_開始'),
('end_fill',                        '結束填', '結束填色', '塗りつぶ_終わり'),
('begin_poly',                      '開始多邊形'),
('clear',                           '清除'),
('clearstamp',                      '清除蓋章'),
('clearstamps',                     '清除蓋章群'),
